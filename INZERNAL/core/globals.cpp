...
namespace opt {
	...
	std::string	gt_version	= "3.59";	//gt version gets spoofed to this
	std::string	gt_supported= "3.56";	//the gt version for which INZERNAL was built for. Probably wont work for other versions.
